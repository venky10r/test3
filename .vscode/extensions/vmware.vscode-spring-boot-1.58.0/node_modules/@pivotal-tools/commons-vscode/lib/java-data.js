...
exports.registerJavaDataService = void 0;
...
function registerJavaDataService(client) {
    ...
    const projectGav = new vscode_languageclient_1.RequestType("sts/project/gav");
    client.onRequest(projectGav, (params) => __awaiter(this, void 0, void 0, function* () { return yield VSCode.commands.executeCommand("java.execute.workspaceCommand", "sts.project.gav", params); }));
}
