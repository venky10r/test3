...
exports.systemBoot2Prompt = exports.systemBoot3Prompt = exports.systemPrompt = void 0;
const copilotRequest_1 = __importDefault(require("./copilotRequest"));
exports.systemPrompt = `**Your task is to create Java source code for a Spring Boot application. Follow these guidelines:**
- IMPORTANT: CONCLUDE YOUR RESPONSE WITH THE MARKER \"//${copilotRequest_1.default.DEFAULT_END_MARK}\"  TO INDICATE END OF RESPONSE.
...
`;
exports.systemBoot3Prompt = `For Spring Boot 3 and above:
