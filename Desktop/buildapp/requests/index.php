			...
			<div class="row">
				<div class="col">
					<div class="home_content text-center">
						<div class="home_title">Booking Requests</div>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="row">
							<div class="col-lg">
								<div class="property_info">
									<div class="tag_price listing_price col-md-12" style="text-align: center">Booking Status</div><div>&nbsp;</div>                                                                      
